...
fun RegisterScreen(onClickBack: ()-> Unit ={}, onSuccessfulRegister: ()-> Unit ={}) {
    ...
    var confirmationPasswordError by remember { mutableStateOf("") }
    ...
    Scaffold(
        ...
        Column(
            ...
            OutlinedTextField(
                ...
                shape = RoundedCornerShape(12.dp),
                supportingText = {
                    if (confirmationPasswordError.isNotEmpty()){
                        Text(
            ...
            Button(
                onClick = {
                    ...
                    val isValidConfirmationPassword = validateConfirmationPassword(inputPassword, inputPasswordConfirmation).first
